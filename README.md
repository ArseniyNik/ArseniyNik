...
- Building multi-agent systems supporting internal workflows and client-facing processes  
- Chatbot development for automation and interaction scenarios  
- Server setup & administration: Linux, Docker, Nginx, reverse proxies, security configuration  
...
- full responsibility cycle: from ideation to delivery  
